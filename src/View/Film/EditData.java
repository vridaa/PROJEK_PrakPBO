...
public class EditData extends JFrame {
    ...
    JLabel header = new JLabel("EDIT DATA FILM");
    ...
    public EditData(ModelFilm film, String username, int userId) {
        ...
        tombolEdit.setBounds(100, 320, 100, 40);
        ...
        inputJudul.setText(film.getJudul());
        inputDurasi.setText(String.valueOf(film.getDurasi()));
        inputGenre.setText(film.getGenre());
        inputKategori.setSelectedItem(film.getKategori());
        inputTanggal.setDate(film.getTanggal_tayang_perdana());
        inputHarga.setText(String.valueOf(film.getHargafilm()));
